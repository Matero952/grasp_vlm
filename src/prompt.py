def generate_prompt(tool, annotation_type):
    ...
    if annotation_type == "index_finger":
        ...
        part_c = f"Return your final answer in json as a bounding box around the best placement of the pad of the index finger in the format: [y_min, x_min, y_max, x_max]. Return only the bounding box in json as your answer."
    else:
        ...
        part_c = f"Return your final answer in json as a single bounding box around the best placement of the four fingers' contact area in the format: [y_min, x_min, y_max, x_max]. Return only the bounding box in json as your answer."
